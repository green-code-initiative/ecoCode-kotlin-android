...
class AbstractKotlinSensorTest : AbstractSensorTest() {
    ...
    private fun sensor() = DummyKotlinSensor(checkFactory("DummyKotlinCheck"), listOf(DummyKotlinCheck::class.java))
}

private val LOG = LoggerFactory.getLogger(DummyKotlinSensor::class.java)
class DummyKotlinSensor(checkFactory: CheckFactory, checks: List<Class<out KotlinCheck>>) :
